...
/**
 * Catálogo — Pokédex de espécies em prateleiras de loja vintage.
 * Plantas desbloqueadas aparecem coloridas. Bloqueadas: silhueta + cadeado.
 * (O "Meu Jardim" 3D vive em /jardim; aqui é a coleção de espécies.)
 */
      ...
      <header className="px-4 pt-4 pb-2 flex items-end justify-between">
        <div>
          ...
          <p className="text-sm text-[var(--color-ink-faint)]">
            {unlockedCount} / {total} espécies descobertas
          </p>
        </div>
        <button
          aria-label="Buscar"
